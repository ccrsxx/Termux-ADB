...
wget https://github.com/ccrsxx/Termux-ADB/raw/master/bin/adb.bin -P $downpath/ -q
wget https://github.com/ccrsxx/Termux-ADB/raw/master/bin/fastboot -P $downpath/ -q
wget https://github.com/ccrsxx/Termux-ADB/raw/master/bin/fastboot-armeabi -P $downpath/ -q
